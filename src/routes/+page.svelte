...
<main class=" px-10 py-10 font-mono bg-blue-700">
<div class="text-blue-900" >


  <div>
    <p class=" text-xl"> Ongoing Projects</p>
    <ul>
...
<ul>
  <li><span class ="text-3xl text-slate-200"> For Content Only</span> (2024)</li>
  <li><span class ="text-3xl text-slate-200"> Proof-of-Work</span> (2022-2023,PH-USA)</li>
  <li><span class ="text-3xl text-slate-200">P1sonet2022</span>(2022,CCP,PH)</li>
  <li><span class ="text-3xl text-slate-200">Bituon Project</span>(2019,Cebu-Bali)</li>
</ul>
